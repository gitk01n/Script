...
!(async () => {
  ...
  for (let i = 2; i <= tfbcount; i++) {
    ...
    console.log(`------------- 共${tfbhdArr.length}个账号-------------\n`)
     ...
     $.log("每日上限阅读看返回的提示 大概37次后限制半小时阅读一次") 
     $.log("提现金额如果达标 将会自动提现") 
...
async function sign(body){
 ...
 let plant6_url = {
  ...
  async function txsign(body,gold){
 return new Promise((resolve) => {
...
token = tk.token
 ...
 let plant6_url = {
       url: `https://hh.102727.com/user/pickAuto`,
        headers: {
"Content-Type": "application/json;charset=UTF-8",
"Host": "hh.102727.com",
"Origin": "https://h8.102727.com",
"Referer": "https://h8.102727.com/",
